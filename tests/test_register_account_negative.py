...
class TestNegativeScenarios:
    ...
    def test_privacy_police_unchecked(self, driver):
        ...
        error_message = register_page.clear_text(register_page.get_error_message())
        expected_message = register_page.clear_text("Error: You must agree to the Privacy Policy!")
